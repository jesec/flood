...
const RatioIcon: FC<RatioIconProps> = memo(({className}: RatioIconProps) => (
  <svg className={classnames('icon', 'icon--ratio', className)} viewBox="0 0 60 60">
