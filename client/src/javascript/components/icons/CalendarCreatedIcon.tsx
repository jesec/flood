...
interface CalendarCreatedIconProps {
  className?: string;
}

const CalendarCreatedIcon: FC<CalendarCreatedIconProps> = memo(({className}: CalendarCreatedIconProps) => (
...
CalendarCreatedIcon.defaultProps = {
  className: undefined,
};

export default CalendarCreatedIcon;
