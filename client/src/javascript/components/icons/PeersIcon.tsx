...
interface PeersIconProps {
  className?: string;
}

const PeersIcon: FC<PeersIconProps> = memo(({className}: PeersIconProps) => (
  <svg className={classnames('icon', 'icon--peers', className)} viewBox="0 0 60 60">
