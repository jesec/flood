export default {
  ...
  'connectivity.modal.content':
    'Impossible de se connecter à rTorrent. Veuillez mettre à jour les informations maintenant.',
  ...
  'mediainfo.execError':
    "Une erreur est survenue lors de l'exécution de mediainfo sur le serveur. Vérifiez que mediainfo est installé et disponible dans le PATH à Flood.",
  ...
  'settings.ui.torrent.details.tags.placement':
    'Dans la vue étendue, les balises fonctionnent mieux à la fin de la liste.',
