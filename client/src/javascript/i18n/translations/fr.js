export default {
    'actionbar.button.start.torrent': 'Démarrer le Torrent',
    'actionbar.button.stop.torrent': 'Arrêter le torrent',
    'actionbar.button.add.torrent': 'Ajouter un torrent',
    'actionbar.button.remove.torrent': 'Supprimer le torrent',
    ...
    'alert.torrent.move.failed': `Le déplacement de {countElement} {count, plural, =1 {torrent} other {torrents}} a échoué.`,
    'alert.torrent.remove': `La suppression de {countElement} {count, plural, =1 {torrent} other {torrents}} a réussi.`,
    'alert.torrent.remove.failed': `La suppression de {countElement} {count, plural, =1 {torrent} other {torrents}} a échoué.`,
    'alert.settings.saved': 'Paramètres modifiés.',
    'auth.add.user': 'Ajouter un Utilisateur',
    'auth.connectionType': 'Type de connexion rTorrent',
    ...
    'auth.create.an.account.intro': 'Bienvenue dans Flood!',
    'auth.current.user': 'Utilisateur actuel',
    ...
    'auth.rtorrentHost': 'Hôte rTorrent',
    'auth.rtorrentPort': 'Port rTorrent',
    'auth.rtorrentSocket': 'Socket rTorrent',
    'auth.rtorrentSocketPath': 'Chemin de la chaussure rTorrent',
    'button.add': 'Ajouter',
    ...
    'connectivity.modal.content': 'Impossible de se connecter à rTorrent. Veuillez mettre à jour les informations maintenant.',
    ...
    'feeds.url': 'URL',
    'feeds.search': 'Terme de recherche',
    ...
    'feeds.browse.feeds': 'Parcourir les flux',
    'filesystem.empty.directory': 'Répertoire vide.',
    'filesystem.error.eacces': 'Flood n\'a pas la permission de lire ce répertoire.',
    'filesystem.error.enoent': 'Ce chemin n\'existe pas. Il sera créé.',
    'filesystem.fetching': 'Récupération de la structure du répertoire...',
    'filter.all': 'Tout',
    ...
    'filter.status.checking': 'En cours de vérification',
    ...
    'general.to': 'à',
    'general.of': 'de',
    'general.clipboard.copy': 'Copie',
    'general.clipboard.copied': 'Copié',
    'mediainfo.execError': 'Une erreur est survenue lors de l\'exécution de mediainfo sur le serveur. Vérifiez que mediainfo est installé et disponible dans le PATH à Flood.',
    'mediainfo.fetching': 'Récupération en cours...',
    'mediainfo.heading': 'Sortie Mediainfo',
    ...
    'notification.showing': 'Affichage en cours',
    ...
    'settings.tabs.diskusage': 'Utilisation du disque',
    'settings.tabs.about': 'À propos',
    'settings.ui.locale': 'Traductions',
    'settings.ui.language': 'Langue',
    'settings.ui.torrent.list': 'Affichage de la liste des torrents',
    'settings.ui.torrent.size': 'Taille du torrent',
    'settings.ui.torrent.size.expanded': 'Vue étendue',
    'settings.ui.torrent.size.condensed': 'Vue condensée',
    'settings.ui.torrent.details.enabled': 'Activé',
    'settings.ui.torrent.details.tags.placement': 'Dans la vue étendue, les balises fonctionnent mieux à la fin de la liste.',
    'settings.ui.displayed.details': 'Colonnes de détail du torrent',
    'settings.diskusage.show': 'Afficher',
    'settings.diskusage.mount.points': 'Points de montage d\'utilisation du disque',
    ...
    'sidebar.button.log.out': 'Déconnexion',
    ...
    'torrents.details.actions.pause': 'Mettre en pause',
    ...
    'torrents.details.files.loading': 'Chargement des détails du fichier...',
    'torrents.details.files.download.file': `{count, plural, =1 {Téléchargez le fichier} other {Téléchargez les fichiers}}`,
    ...
    'torrents.details.selected.files': `{count, plural, =1 {{countElement} fichier sélectionné} other {{countElement} fichiers sélectionnés}}`,
    ...
    'torrents.details.trackers.type': 'Type de texte',
    ...
    'torrents.list.context.details': 'Détails du torrent',
    ...
    'torrents.list.drop': 'Déposez les fichiers ici pour les ajouter à rTorrent.',
    'torrents.list.cannot.connect': 'Impossible de se connecter à rTorrent.',
    ...
    'torrents.move.check_hash.label': 'Vérifier le hachage',
    ...
    'torrents.remove.are.you.sure': `Êtes-vous certain(e) de vouloir supprimer {count, plural, =0 {aucun torrent} =1 {un torrent} other {# torrents}} ?`,
    ...
    'connection-interruption.heading': 'Impossible de se connecter à rTorrent',
    'connection-interruption.verify-settings-prompt': 'Vérifions vos paramètres de connexion.',
    'connection-interruption.verification-error': 'La connexion n\'a pas pu être vérifiée.',
    'connection-interruption.verification-success': 'Connexion réussie',
