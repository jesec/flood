export default {
    ...
    'mediainfo.execError': '在服务器上运行mediainfo时发生错误。检查mediainfo是否已经安装，并且在PATH中正确配置！',
    ...
    'torrents.details.general.connected': '已连接到 {total} 中的 {connected}',
    ...
    'torrents.remove.are.you.sure': `你确定你想要删除 {count, plural,
      =0 {0 个种子}
      other {# 个种子}
    }`,
