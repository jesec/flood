export default {
  ...
  'settings.bandwith.slots.download.global.label': 'Download Slots Global',
  'settings.bandwith.slots.download.label': 'Download Slots Per Torrent',
  'settings.bandwith.slots.heading': 'Slot Availability',
  'settings.bandwith.slots.upload.divider.label': 'Upload Slots Divider',
  'settings.bandwith.slots.upload.global.label': 'Upload Slots Global',
  'settings.bandwith.slots.upload.label': 'Upload Slots Per Torrent',
  'settings.bandwith.transferrate.dropdown.preset.download.label': 'Dropdown Presets: Download',
  'settings.bandwith.transferrate.dropdown.preset.upload.label': 'Dropdown Presets: Upload',
  'settings.bandwith.transferrate.global.throttle.download': 'Global Download Rate Throttle',
  'settings.bandwith.transferrate.global.throttle.upload': 'Global Upload Rate Throttle',
  'settings.bandwith.transferrate.heading': 'Transfer Rate Throttles',
  ...
  'settings.tabs.bandwith': 'Bandwidth',
