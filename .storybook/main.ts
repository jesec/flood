...
const config: StorybookConfig = {
  stories: [
    '../client/src/javascript/components/**/*.stories.@(js|jsx|mjs|ts|tsx)',
    '../client/src/javascript/routes/**/*.stories.@(js|jsx|mjs|ts|tsx)',
  ],
  addons: ['@storybook/addon-onboarding', '@storybook/addon-webpack5-compiler-babel'],
  framework: {
    name: '@storybook/react-webpack5' as const,
    options: {},
  },
  swc: () => ({
    jsc: {
