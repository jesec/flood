...
import type {AddTorrentByURLOptions, AddTorrentByFileOptions} from '@shared/schema/api/torrents';
...
const TorrentActions = {
  ...
  // Add torrent methods
  addTorrentsByUrls: ({urls, destination, tags, isBasePath, start}: AddTorrentByURLOptions) => {
